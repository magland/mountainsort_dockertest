% MATLAB code to prepare 2nd M=128 ch Neto-Kampff downloaded data for sorting.
% edited from ss_datasets/Kampff/convert_kampff_to_mda.m
% Barnett 3/30/17-3/31/17. Better true firings & move to fi_ss 4/21/17.

dir='/data/ahb/neuron/Kampff/2015_09_04_Pair_5_0'; % set to downloaded location
...
% put this in netokampff/juxta128_2/geom.csv
a=textread([dir '/128-chgeom-reorg_clean.csv'],'','delimiter',',');
...
writemda16i(Y,[dir '/kampff128_2_raw.mda']); % 16bit signed
%writemda16i(Y(:,1:1800000),[dir '/kampff128_2_1min_raw.mda']); % 16bit signed
% etc
clear Y
